...
const evaluateScore = (playerMove, elfMove) => {
	...
	switch (elfMove) {
		case "A":
			if(playerMove === "X") currentScore = LOOSE_SCORE + SCISSOR_SCORE
			if(playerMove === "Y") currentScore = DRAW_SCORE + ROCK_SCORE
			if(playerMove === "Z") currentScore = WIN_SCORE + PAPER_SCORE
			break
		case "B":
			...
			break
		case "C":
			if(playerMove === "X") currentScore = LOOSE_SCORE + PAPER_SCORE
			if(playerMove === "Y") currentScore = DRAW_SCORE + SCISSOR_SCORE
			if(playerMove === "Z") currentScore = WIN_SCORE + ROCK_SCORE
			break
	}
